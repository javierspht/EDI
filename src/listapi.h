...
private:
	...
	public:
		...
		TipoDato  dato; //Dato almacenado en el nodo
		Nodo     *siguiente;  //Enlace al siguiente elemento de la lista
		Nodo     *anterior;   //Enlace al anterior elemento de la lista
	...
	Nodo *inicio;   //Enlace al primer elemento de la lista
	Nodo *fin;		//Enlace al último elemento de la lista
	Nodo *pI;	    //Enlace al elemento pI de la lista
